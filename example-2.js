...
`deposit(amount, onSuccess, onError)`, where the first parameter is the amount of the 
operation, and second and third are callbacks.
...
const account = {
  ...
  withdraw(amount, onSuccess, onError) {         //* --> Higher Order Function  //
...
function handleSuccess(message) {                //* --> Callback Function  //
  console.log(`✅ Success! ${message}`);
}

function handleError(message) {                  //* --> Callback Function  //
